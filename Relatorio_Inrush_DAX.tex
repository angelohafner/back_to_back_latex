...
\begin{itemize}[label=\textendash]
	\item	Potencia reativa  = 7 MVAr
	\item	Tensão trifásica  = 14 kV
	\item	Tensão monofásica  = 8 kV
	\item	Corrente de curto-circuito  = 16 kA
\end{itemize}
...
\midrule
0 & 1.8 MVAr & 600.0 kVAr & 13.8 kV & 8.0 kV & 75.3 A & 105.8 $\Omega$ & 25.07 µF & 50.0 µH & 20.0 & 856.9 Hz \\
1 & 1.8 MVAr & 600.0 kVAr & 13.8 kV & 8.0 kV & 75.3 A & 105.8 $\Omega$ & 25.07 µF & 50.0 µH & 50.0 & 4.3 kHz \\
2 & 1.8 MVAr & 600.0 kVAr & 13.8 kV & 8.0 kV & 75.3 A & 105.8 $\Omega$ & 25.07 µF & 50.0 µH & 66.7 & 4.3 kHz \\
3 & 1.8 MVAr & 600.0 kVAr & 13.8 kV & 8.0 kV & 75.3 A & 105.8 $\Omega$ & 25.07 µF & 50.0 µH & 75.0 & 4.3 kHz \\
\bottomrule
\end{tabular}
...
São os valores obtidos com o reator escolhido ($L_{reator} = 50.0 \, \mu \rm{H} $):
\begin{itemize}[label=\textendash]
	\item	Corrente de pico: 8 kA;
	\item	Frequência de Oscilação: 4.3 kHz;
	\item	Corrente inrush / Corrente nominal: 75.0
\end{itemize}
